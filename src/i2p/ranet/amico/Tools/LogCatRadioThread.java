...
public class LogCatRadioThread {
	private static final String TAG="LogCatRadioThread";
	...
	private static final String logPath="/sdcard/radio_";
	...
	public LogCatRadioThread(Context c) 
	{
		mContext=c;
